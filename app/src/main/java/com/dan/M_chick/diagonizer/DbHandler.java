package com.dan.M_chick.diagonizer;
...
public class DbHandler extends SQLiteOpenHelper {
    private static String database_name="magonjwa.db";
    private static  String table_name="magonjwa";
    private static String coloumn_diseases="disease";
...
onCreate(db);
    ...
    public void addMagonjwa(Magonjwa m)
    {
    ...
    public String[] checkMagonjwa(String[] select,int i)
    {
        String s="";
